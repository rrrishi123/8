...
WIRE = "/home/claude/wire/http-mcp/http-mcp"
STATE_F = "/home/claude/wire/pipeline_state.json"
MANIFEST_F = "/home/claude/wire/frame_zero_v2.json"
CLIPS = "/home/claude/wire/clips"
...
class H(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        if self.path=="/state": self._s(state)
            ...
            out="/mnt/user-data/outputs/frame-zero-cut.mp4"
